...
\fancyhead[C]{PHY121}
\fancyhead[R]{\thepage}
\fancyfoot[L]{Lab Report 13-A: Real vs Ideal Oscillations}
\fancyfoot[R]{\thepage}
...
\title{
    ...
    \textbf{\Huge Lab Report 13-A: Real vs Ideal Oscillations} \\
    \vspace{1cm} % Adjust vertical space
    \large PHY121 \\
    \vspace{0.5cm} % Adjust vertical space
    \large	November, 23rd, 2024 \\ 
		\vspace{.5cm}
		\large Professor R. Lathrop | Professor M. Petralia
}
