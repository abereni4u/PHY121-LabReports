...
\textbf{Trial 2 Period (s)}     & 0.252  & 0.4575 & 0.5015 & 11.36  \\
\textbf{Average Period (s)}     & 0.2625 & 0.5787 & 0.5015 & 5.961  \\
\textbf{Average Velocity (m/s)} & 2.393  & 1.628  & 2.505  & 0.3162 \\
\textbf{F\textsubscript{c} (N)} & 0.9138 & 0.2819 & 0.5007 & 0.0053 \\ \bottomrule
\end{tabular}%
}
\end{table}
